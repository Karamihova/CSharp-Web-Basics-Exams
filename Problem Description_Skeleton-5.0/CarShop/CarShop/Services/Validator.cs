namespace CarShop.Services
{
    ...
    public class Validator : IValidator
    {
        public ICollection<string> ValidateCar(AddCarFormModel car)
        {
            ...
            if (car.Model == null || car.Model.Length < DefaultMinLength || car.Model.Length > DefaultMaxLength)
            {
                errors.Add($"Model '{car.Model}' is not valid. It must be between {DefaultMinLength} and {DefaultMaxLength} characters long.");
            }
        ...
        public ICollection<string> ValidateUser(RegisterUserFormModel user)
        {
            ...
            if (user.Password == null || user.Password.Length < DefaultMinLength || user.Password.Length > DefaultMaxLength)
            {
